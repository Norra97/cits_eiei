...
app.use('/public', express.static('C:/cits_eiei/public'));  
...
app.get("/", function (_req, res) {
    res.sendFile("C:/cits_eiei/public/web_pro/login regis/login.html");
});
...
app.get("/student", function (req, res) {
    res.sendFile("C:/cits_eiei/public/web_pro/student/std-dash.html");
});
//-----Route to serve the Asset student home page-----//
app.get("/student/Asset", function (req, res) {
    res.sendFile("C:/cits_eiei/public/web_pro/student/std-asset.html");
});
//-----Route to serve the Asset Accept student home page-----//
app.get("/student/Asset-accept", function (req, res) {
    res.sendFile("C:/cits_eiei/public/web_pro/student/std-asset accept.html");
});
//-----Route to serve the Calendar student home page-----//
app.get("/student/calendar", function (req, res) {
    res.sendFile("C:/cits_eiei/public/web_pro/student/calendar.html");
});
//-----Route to serve the setting page-----//
app.get("/settings/std", function (_req, res) {
    res.sendFile("C:/cits_eiei/public/web_pro/student/std-sta-rt.html");
});

app.get("/student/sta/pd", function (_req, res) {
    res.sendFile("C:/cits_eiei/public/web_pro/student/std-sta-pd.html");
});
...
app.get("/student/sta/br", function (req, res) {
    res.sendFile("C:/cits_eiei/public/web_pro/student/std-sta-br.html");
});
app.get("/student/sta/rj", function (_req, res) {
    res.sendFile("C:/cits_eiei/public/web_pro/student/std-sta-rj.html");
});
app.get("/student/sta/rpd", function (_req, res) {
    res.sendFile("C:/cits_eiei/public/web_pro/student/std-sta-rpd.html");
});
app.get("/student/set", function (_req, res) {
    res.sendFile("C:/cits_eiei/public/web_pro/student/std-setting.html");
});
...
app.get("/staff", function (req, res) {
    res.sendFile("C:/cits_eiei/public/web_pro/staff/stf-dash.html");
});

//-----Route to EditAsset-----//
app.get("/staff/Edit-Asset", function (req, res) {
    res.sendFile("C:/cits_eiei/public/web_pro/staff/test.html");
});

//-----Route to staff History-----//

app.get("/staff/History", function (req, res) {
    res.sendFile("C:/cits_eiei/public/web_pro/staff/stf-history.html");
});

app.get("/staff/History-Re", function (req, res) {
    res.sendFile("C:/cits_eiei/public/web_pro/staff/stf-history-re.html");
});


//-----Route to  staff Returning-----//
app.get("/staff/Returning", function (req, res) {
    res.sendFile("C:/cits_eiei/public/web_pro/staff/stf-returning.html");
});

//-----Route to serve the setting page-----//
app.get("/settings/stf", function (_req, res) {
    res.sendFile("C:/cits_eiei/public/web_pro/staff/stf-setting.html");
});


//-----Route to serve the lecturer dashboard page-----//
app.get("/lecturer", function (req, res) {
    res.sendFile("C:/cits_eiei/public/web_pro/lect/lec-dash.html");
});

app.get("/lecturer/MangeUser", function (req, res) {
    res.sendFile("C:/cits_eiei/public/web_pro/lect/lec-mangeuser.html");
});

app.get("/lecturer/Borrowing-requests", function (req, res) {
    res.sendFile("C:/cits_eiei/public/web_pro/lect/lec-borr-req.html");
});

app.get("/lecturer/history", function (req, res) {
    res.sendFile("C:/cits_eiei/public/web_pro/lect/lec-history.html");
});

//-----Route to serve the setting page-----//
app.get("/settings/lec", function (_req, res) {
    res.sendFile("C:/cits_eiei/public/web_pro/lect/lec-setting.html");
});

app.get("/lecturer/AddAsset", function (_req, res) {
    res.sendFile("C:/cits_eiei/public/web_pro/lect/lec-addasset.html");
});
...
app.get("/register", function (_req, res) {
    res.sendFile("C:/cits_eiei/public/web_pro/login regis/register.html");
});
